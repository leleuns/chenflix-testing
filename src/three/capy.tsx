...
const Model = () => {
  ...
  //spotlight
  const spotLight = new THREE.SpotLight(0xffffff, 1500, 1500, 0.25, 1)
...
export default function Capybara() {
  ...
  return (
    <div className="Capybara w-screen h-screen">
      <Canvas camera={camera} scene={scene}>
          <Model />
          <OrbitControls autoRotate minDistance={3} maxDistance={25} maxPolarAngle={Math.PI/2.5}/>
      </Canvas>
    </div>
  );
}
